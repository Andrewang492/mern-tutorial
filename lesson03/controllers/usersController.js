...
const asyncHandler = require('express-async-handler') // stops us using too many try castch
...
const createNewUser = asyncHandler(async (req, res) => {
    ...
    const duplicate = await User.findOne({ username }).lean().exec() //should call exec at end of async if you pass something in. Mongo documentation.
